...
<script type="text/javascript">
	...
	$(function(){
		...
		//	为关联市场活动模态窗口搜索框绑定键盘事件 回车键按下进行搜索
		$("#aname").keydown(function (event) {
			...
			if (code === 13) {
				...
				//	查询与模糊搜索框中相关的市场活动并展现
				$.ajax({
					url : "workbench/clue/getRelatedActivityByActivityName.do",
					data : {
					...
					success : function (data) {
						...
						$("#relatedActivityModalTblBody").html(html);
					}
				})
		...
		$("#relatedActivityModalTblBody").on("click", $("input[name=select]"), function () {
		...
		$("#relateBtn").click(function () {
			...
			$.ajax({
				url : "workbench/clue/addRelatedActivity.do",
				data : {
					"id" : "${clue.id}",
					"aid" : param
				},
	...
	function loadRelatedActivity() {
		$.ajax({
			url : "workbench/clue/loadRelatedActivity.do",
			data : {
				"id" : "${clue.id}"
			},
			type : "get",
			...
			success : function (data) {
				...
				$("#relatedActivityTblBody").html(html);
			}
		})
	}
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<table id="activityTable" class="table table-hover" style="width: 900px; position: relative;top: 10px;">
						...
						<tbody id="relatedActivityModalTblBody">
						</tbody>
					</table>
				</div>
		...
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table class="table table-hover" style="width: 900px;">
					...
					<tbody id="relatedActivityTblBody">
<%--						<tr>--%>
<%--							<td>发传单</td>--%>
<%--							<td>2020-10-10</td>--%>
<%--							<td>2020-10-20</td>--%>
